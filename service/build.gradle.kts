...
dependencies {
    ...
    componentTestImplementation("io.github.lsd-consulting:lsd-cucumber:6.+") {
        because("we want to include the Cucumber scenarios in the LSDs")
    }

    componentTestImplementation("io.github.lsd-consulting:lsd-interceptors:5.+") {
        because("we want to include the Cucumber scenarios in the LSDs")
    }
    ...
    // Cucumber
    componentTestImplementation("io.cucumber:cucumber-java8:7.31.0") {
        because("we want to use Cucumber JVM")
    }
    componentTestImplementation("io.cucumber:cucumber-junit-platform-engine:7.31.0") {
        because("we want to use Cucumber with JUnit 5")
    }
    componentTestImplementation("io.cucumber:cucumber-spring:7.31.0") {
