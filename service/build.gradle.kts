...
dependencies {
    ...
    // Cucumber
    componentTestImplementation("io.cucumber:cucumber-java8:7.34.8") {
        because("we want to use Cucumber JVM")
    }
    componentTestImplementation("io.cucumber:cucumber-junit-platform-engine:7.34.8") {
        because("we want to use Cucumber with JUnit 5")
    }
    componentTestImplementation("io.cucumber:cucumber-spring:7.34.8") {
